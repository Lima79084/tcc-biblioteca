											...
											<div class="row mb-4">
												...
												<div class="col-md-4">
													<div class="form-outline">
														...
														<input type="text" class="form-control" id="categoria" name="categoria" value="${livro.categoria}" required="required"  />
													</div>
												</div>
											...
											<div class="row mb-4">
												...
												<div class="col-md-3">
													<div class="form-outline">
														...
														<input type="text" class="form-control" id="editora" name="editora" value="${livro.editora}" required="required"  />
													</div>
												</div>
